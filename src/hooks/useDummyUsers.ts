...
const ROOM_DATA = [
  { id: 'lobby', weight: 100, names: 'indian' },
  { id: 'mumbai', weight: 0, names: 'indian' },
  { id: 'delhi', weight: 0, names: 'indian' },
  { id: 'bangalore', weight: 0, names: 'indian' },
  { id: 'usa', weight: 0, names: 'western' },
  { id: 'uk', weight: 0, names: 'western' },
  { id: 'canada', weight: 0, names: 'western' },
  { id: 'australia', weight: 0, names: 'western' },
  { id: 'uae', weight: 0, names: 'arabic' },
  { id: 'singapore', weight: 0, names: 'east_asian' },
  { id: 'germany', weight: 0, names: 'western' },
  { id: 'saudi', weight: 0, names: 'arabic' },
  { id: 'japan', weight: 0, names: 'east_asian' },
  { id: 'hyderabad', weight: 0, names: 'indian' },
  { id: 'chennai', weight: 0, names: 'indian' },
  { id: 'kolkata', weight: 0, names: 'indian' },
  { id: 'lucknow', weight: 0, names: 'indian' },
];
