...
const NAME_POOLS: Record<string, { male: string[], female: string[] }> = {
  ...
  western: {
    male: ['James', 'Robert', 'John', 'Michael', 'David', 'William', 'Richard', 'Joseph', 'Thomas', 'Christopher', 'Charles', 'Daniel', 'Matthew', 'Anthony', 'Mark', 'Donald', 'Steven', 'Paul', 'Andrew', 'Joshua', 'Kevin', 'Brian', 'George', 'Timothy', 'Ronald', 'Edward', 'Jason', 'Jeffrey', 'Ryan', 'Jacob', 'Gary', 'Nicholas', 'Eric', 'Stephen', 'Adam', 'Alan', 'Austin', 'Benjamin', 'Brandon', 'Bryan', 'Carl', 'Chad', 'Christian', 'Cody', 'Connor', 'Corey', 'Craig', 'Derek', 'Dominic', 'Dustin', 'Dylan', 'Ethan', 'Evan', 'Frank', 'Gabriel', 'Gregory', 'Ian', 'Isaac', 'Jack', 'Jerry', 'Jesse', 'Joe', 'Jordan', 'Justin', 'Keith', 'Kenneth', 'Kyle', 'Larry', 'Lawrence', 'Logan', 'Lucas', 'Luke', 'Marcus', 'Nathan', 'Noah', 'Owen', 'Patrick', 'Peter', 'Philip', 'Raymond', 'Samuel', 'Scott', 'Sean', 'Seth', 'Shane', 'Shawn', 'Timothy', 'Todd', 'Travis', 'Trent', 'Tyler', 'Victor', 'Vincent', 'Walter', 'Wayne', 'Zachary', 'Arthur', 'Christian', 'Harry', 'Oliver', 'George', 'Noah', 'Jack', 'Leo', 'Oscar', 'Charlie', 'Teddy', 'Alfie', 'Freddie', 'Archie', 'Theo', 'Arthur', 'Tommy', 'Henry', 'William', 'Lucas', 'Mason', 'Ethan', 'Alex', 'Liam', 'Caleb', 'Nathan', 'Benjamin', 'Isaac', 'Daniel', 'Luke', 'Gavin', 'Owen', 'Wyatt'],
    female: ['Mary', 'Patricia', 'Jennifer', 'Linda', 'Elizabeth', 'Barbara', 'Susan', 'Jessica', 'Sarah', 'Karen', 'Lisa', 'Nancy', 'Betty', 'Margaret', 'Sandra', 'Ashley', 'Kimberly', 'Emily', 'Donna', 'Michelle', 'Dorothy', 'Carol', 'Amanda', 'Melissa', 'Deborah', 'Stephanie', 'Rebecca', 'Sharon', 'Laura', 'Abigail', 'Alice', 'Amy', 'Angela', 'Ann', 'Anna', 'Annie', 'Audrey', 'Beverly', 'Brenda', 'Brittany', 'Catherine', 'Cheryl', 'Christina', 'Christine', 'Cindy', 'Claire', 'Courtney', 'Crystal', 'Cynthia', 'Danielle', 'Dawn', 'Denise', 'Diana', 'Diane', 'Erica', 'Erin', 'Evelyn', 'Felicia', 'Florence', 'Gloria', 'Grace', 'Hannah', 'Hazel', 'Heather', 'Helen', 'Holly', 'Irene', 'Iris', 'Isabella', 'Jackie', 'Jacqueline', 'Jane', 'Janet', 'Janice', 'Jean', 'Jill', 'Joan', 'Joanne', 'Joy', 'Joyce', 'Judith', 'Judy', 'Julia', 'Julie', 'June', 'Katherine', 'Kathleen', 'Kathryn', 'Kathy', 'Katie', 'Kayla', 'Kelly', 'Kendra', 'Kerry', 'Kristin', 'Kristina', 'Lauren', 'Laurie', 'Leslie', 'Lillian', 'Lily', 'Lois', 'Lori', 'Louise', 'Lucy', 'Lydia', 'Lynn', 'Mabel', 'Madeline', 'Madison', 'Mae', 'Marie', 'Marilyn', 'Marion', 'Marjorie', 'Martha', 'Maureen', 'Maxine', 'Megan', 'Melanie', 'Melinda', 'Meredith', 'Mildred', 'Molly', 'Monica', 'Muriel', 'Myra', 'Myrtle', 'Nadine', 'Nanette', 'Naomi', 'Natalie', 'Nellie', 'Nettie', 'Nicole', 'Nina', 'Nora', 'Norma', 'Olive', 'Olivia', 'Pamela', 'Paula', 'Pearl', 'Peggy', 'Penny', 'Phyllis', 'Priscilla', 'Rachel', 'Ramona', 'Renee', 'Rhonda', 'Rita', 'Roberta', 'Rose', 'Rosemary', 'Ruby', 'Ruth', 'Sally', 'Samantha', 'Sara', 'Sarah', 'Savannah', 'Selma', 'Shannon', 'Sheila', 'Shelley', 'Sheryl', 'Shirley', 'Sonia', 'Sophia', 'Stacey', 'Stella', 'Sylvia', 'Tamara', 'Tammy', 'Tanya', 'Tara', 'Teresa', 'Thelma', 'Theresa', 'Tiffany', 'Tina', 'Toni', 'Tracey', 'Tracy', 'Valerie', 'Vanessa', 'Vera', 'Vicki', 'Victoria', 'Violet', 'Virginia', 'Vivian', 'Wanda', 'Wendy', 'Whitney', 'Yolanda', 'Yvette', 'Yvonne', 'Zoe', 'Scarlett', 'Amelia', 'Chloe', 'Harper', 'Evelyn', 'Aria', 'Ella', 'Sienna', 'Mila', 'Luna', 'Layla', 'Elena', 'Maya', 'Ivy', 'Bella', 'Sofia', 'Aubrey', 'Hazel', 'Aurora', 'Stella', 'Violet', 'Nova', 'Hazel', 'Iris', 'Clara']
  },
  arabic: {
    male: ['Ahmed', 'Mohammed', 'Omar', 'Ali', 'Hassan', 'Ibrahim', 'Mustafa', 'Youssef', 'Zaid', 'Kareem', 'Hamza', 'Fareed', 'Bilal', 'Nasir', 'Khalid', 'Sami', 'Tarik', 'Faisal', 'Abbas', 'Adel', 'Amir', 'Anwar', 'Basam', 'Fadi', 'Ghassan', 'Habib', 'Hadi', 'Ishaq', 'Jamal', 'Kamal', 'Latif', 'Mahir', 'Nabil', 'Rami', 'Sabir', 'Tariq', 'Usama', 'Waleed', 'Yasir', 'Zuhair', 'Zayd', 'Rayan', 'Hamid', 'Idris', 'Jafar', 'Majid', 'Nadim', 'Nasr', 'Qasim', 'Rashid', 'Saif', 'Shadi', 'Talal', 'Wajih', 'Ziad', 'Anas', 'Badr', 'Emad', 'Farhan', 'Hani', 'Hussein', 'Imad', 'Jaafar', 'Laith', 'Mahmoud', 'Mounir', 'Nizar', 'Omran', 'Raed', 'Salim', 'Tamer', 'Ubayd', 'Wassim', 'Yahya', 'Zakaria', 'Ayman', 'Bashir', 'Fouad', 'Hakim', 'Hazem', 'Ismail', 'Jawad', 'Luqman', 'Marwan', 'Mazin', 'Mufid', 'Munir', 'Najah', 'Nail', 'Qays', 'Rayan', 'Reda', 'Sajid', 'Samir', 'Sharif', 'Sufyan', 'Taha', 'Thamer', 'Zafir'],
    female: ['Fatima', 'Layla', 'Aisha', 'Amira', 'Zahra', 'Noor', 'Mariam', 'Salma', 'Habiba', 'Rania', 'Dina', 'Yasmeen', 'Hana', 'Mona', 'Lina', 'Safa', 'Alia', 'Basma', 'Dalal', 'Farah', 'Ghada', 'Hoda', 'Inas', 'Jinan', 'Kholoud', 'Laila', 'Maha', 'Nada', 'Ola', 'Rasha', 'Sahar', 'Tahani', 'Ula', 'Wafa', 'Yara', 'Zainab', 'Amani', 'Asma', 'Badia', 'Bushra', 'Dalia', 'Fadia', 'Halima', 'Iman', 'Kamila', 'Latifa', 'Malak', 'Nabila', 'Nadia', 'Noura', 'Rawan', 'Reem', 'Saja', 'Samar', 'Shadia', 'Soraya', 'Yasmin', 'Zeina', 'Adilah', 'Bahiya', 'Fatin', 'Ghalia', 'Heidi', 'Iffat', 'Jala', 'Karima', 'Lamis', 'Mayssa', 'Najwa', 'Rida', 'Rima', 'Sana', 'Selma', 'Thana', 'Yasmine', 'Zakiya', 'Aziza', 'Faiza', 'Hanan', 'Inaya', 'Jamilah', 'Kamilah', 'Mina', 'Nida', 'Ruba', 'Salimah', 'Shaima', 'Tasnim', 'Yusra', 'Zubaida']
  },
  east_asian: {
    male: ['Wei', 'Li', 'Min', 'Hiroshi', 'Kenji', 'Jae', 'Sang', 'Takumi', 'Yuki', 'Chen', 'Bo', 'Jun', 'Ji', 'Minsu', 'Hyun', 'Kaito', 'Sora', 'Ren', 'Akio', 'Daisuke', 'Eiji', 'Fujio', 'Goro', 'Haruo', 'Ichiro', 'Jiro', 'Kenta', 'Makoto', 'Naoki', 'Osamu', 'Ryo', 'Shin', 'Taro', 'Ukyo', 'Yoshi', 'Zenshiro', 'Daiki', 'Haruto', 'Hayato', 'Kazuki', 'Ryota', 'Shouta', 'Takuya', 'Yuto', 'Dong-hyun', 'Ji-hoon', 'Joon-seo', 'Min-jun', 'Seung-woo', 'Ye-jun', 'Chao', 'Feng', 'Hao', 'Jie', 'Lei', 'Qiang', 'Yang', 'Yong', 'Atsushi', 'Hideki', 'Isamu', 'Katsuro', 'Masao', 'Noboru', 'Satoshi', 'Takeshi', 'Yasuo', 'Ji-su', 'Seong-min', 'Jin-woo', 'Tae-hyun', 'Hyun-woo', 'Ming', 'Sook', 'Ryu', 'Sheng', 'Bao', 'Guo', 'He', 'Huang', 'Jian', 'Kang', 'Long', 'Ping', 'Ru', 'Shun', 'Tian', 'Xiang', 'Xin', 'Zhe'],
    female: ['Mei', 'Lin', 'Sakura', 'Hana', 'Ji-won', 'Su-bin', 'Yuna', 'Aimi', 'Xia', 'Fan', 'Ying', 'Momo', 'Rin', 'Hina', 'Seo-yeon', 'Akemi', 'Cho', 'Emi', 'Fumiko', 'Haruka', 'Itsuki', 'Junko', 'Kumi', 'Maki', 'Nana', 'Oriko', 'Reiko', 'Saki', 'Tomi', 'Ume', 'Yoko', 'Haruna', 'Kokoro', 'Miku', 'Mio', 'Misaki', 'Nanami', 'Yuka', 'Ji-min', 'Ji-yoon', 'Min-ji', 'Seo-hyeon', 'So-yul', 'Ye-eun', 'An', 'Dan', 'Han', 'Hui', 'Jia', 'Lan', 'Li', 'Na', 'Qing', 'Shu', 'Ting', 'Wen', 'Yan', 'Zhen', 'Yuri', 'Ayaka', 'Chiyo', 'Keiko', 'Mai', 'Mayu', 'Natsumi', 'Rika', 'Sayuri', 'Yoshiko', 'Ji-young', 'Su-ji', 'Tae-hee', 'Hyun-ah', 'Min-young', 'Xiuying', 'Zhihao', 'Meiling', 'Eun-ji', 'Hye-jin', 'Seo-yun', 'Yubin']
  }
};
...
function handleDummyResponses(io: Server, roomId: string, senderId: string, targetDummyId?: string) {
  ...
  if (targetDummyId) {
    ...
    const dummy = serverDummyUsers.find(d => d.id === targetDummyId);
    if (dummy && dummy.gender === 'Female' && dummy.responseProfile !== 'Lurker' && dummy.repliesCount < 2) {
      responders.push(dummy);
    }
  } else {
    ...
    if (availableDummies.length > 0) {
      const countToPick = Math.random() > 0.8 ? 2 : 1;
      for (let i = 0; i < countToPick && availableDummies.length > 0; i++) {
        const idx = Math.floor(Math.random() * availableDummies.length);
        responders.push(availableDummies.splice(idx, 1)[0]);
      }
    }
  }
  
  responders.forEach(dummy => {
    let delay = 0;
    ...
    setTimeout(() => {
      ...
      if (targetDummyId) {
        ...
        const privateMsg: ChatMessage = {
          id: messageId,
          senderId: currentDummy.id,
          senderName: currentDummy.nickname,
          senderGender: currentDummy.gender,
          content,
          timestamp,
        ...
        const userSockets = Array.from(sessions.entries())
          .filter(([sid, uid]) => uid === senderId)
          .map(([sid, uid]) => sid);

        userSockets.forEach(sid => io.to(sid).emit('private:message', privateMsg));
      } else {
        // Send Public Reply (if dummy hasn't changed room)
        if (currentDummy.currentRoom === roomId) {
      ...
      currentDummy.repliesCount++;
      currentDummy.usedPools.push(poolIndex);
    }, delay);
  });
}
...
async function startServer() {
  ...
  app.get("/api/config", (req, res) => {
    res.json({
      ...
      VITE_ADSTERRA_KEY_HEADER_728X90: process.env.VITE_ADSTERRA_KEY_HEADER_728X90 || process.env.ADSTERRA_KEY_HEADER_728X90 || process.env.VITE_ADSTERRA_HEADER_728X90 || process.env.ADSTERRA_HEADER_728X90 || process.env.VITE_ADSTERRA_KEY_728X90 || process.env.ADSTERRA_KEY_728X90 || process.env.ADSTERRA_KEY_HEADER_728X90 || "",
      VITE_ADSTERRA_KEY_HEADER_320X50: process.env.VITE_ADSTERRA_KEY_HEADER_320X50 || process.env.ADSTERRA_KEY_HEADER_320X50 || process.env.VITE_ADSTERRA_HEADER_320X50 || process.env.ADSTERRA_HEADER_320X50 || process.env.VITE_ADSTERRA_KEY_320X50 || process.env.ADSTERRA_KEY_320X50 || process.env.ADSTERRA_KEY_HEADER_320X50 || "",
      VITE_ADSTERRA_KEY_FOOTER_728X90: process.env.VITE_ADSTERRA_KEY_FOOTER_728X90 || process.env.ADSTERRA_KEY_FOOTER_728X90 || process.env.VITE_ADSTERRA_FOOTER_728X90 || process.env.ADSTERRA_FOOTER_728X90 || process.env.VITE_ADSTERRA_KEY_728X90 || process.env.ADSTERRA_KEY_728X90 || process.env.ADSTERRA_KEY_FOOTER_728X90 || "",
      VITE_ADSTERRA_KEY_FOOTER_320X50: process.env.VITE_ADSTERRA_KEY_FOOTER_320X50 || process.env.ADSTERRA_KEY_FOOTER_320X50 || process.env.VITE_ADSTERRA_FOOTER_320X50 || process.env.ADSTERRA_FOOTER_320X50 || process.env.VITE_ADSTERRA_KEY_320X50 || process.env.ADSTERRA_KEY_320X50 || process.env.ADSTERRA_KEY_FOOTER_320X50 || "",
      VITE_ADSTERRA_KEY_LEFT_160X600: process.env.VITE_ADSTERRA_KEY_LEFT_160X600 || process.env.ADSTERRA_KEY_LEFT_160X600 || process.env.VITE_ADSTERRA_LEFT_160X600 || process.env.ADSTERRA_LEFT_160X600 || process.env.VITE_ADSTERRA_KEY_160X600 || process.env.ADSTERRA_KEY_160X600 || process.env.ADSTERRA_KEY_LEFT_160X600 || "",
      VITE_ADSTERRA_KEY_RIGHT_160X600: process.env.VITE_ADSTERRA_KEY_RIGHT_160X600 || process.env.VITE_ADSTERRA_KEY_RIGHT_160X600 || process.env.VITE_ADSTERRA_RIGHT_160X600 || process.env.ADSTERRA_RIGHT_160X600 || process.env.VITE_ADSTERRA_KEY_160X600 || process.env.ADSTERRA_KEY_160X600 || process.env.ADSTERRA_KEY_RIGHT_160X600 || "",
    });
  });
  ...
  io.on("connection", (socket) => {
    ...
    socket.on('send:private', (data) => {
      ...
      const recipient = dummyRecipient || realRecipient;
      ...
      const isBlocked = !dummyRecipient && (recipient as User).blockedUsers?.has(user.id);
      if (isBlocked) {
      ...
      // Always send back to sender for their DM UI
